...
const Page = () => {
  ...
  return (
    <main className="min-h-screen bg-[#050505] text-green-400 font-mono flex items-center justify-center p-6">
      <div className="w-full max-w-4xl rounded-xl border border-green-500/20 bg-black shadow-2xl shadow-green-500/5 overflow-hidden">
        
        {/* Header */}
        <div className="flex items-center gap-2 px-5 py-3 border-b border-green-500/20 bg-[#0a0a0a]">
        ...
        {/* Terminal */}
        <div className="p-6 min-h-[350px] text-sm leading-7">
          {logs.map((log, index) => (
            <div
              key={index}
              className={
        ...
        {/* Footer */}
        <div className="px-6 py-3 border-t border-green-500/10 bg-[#080808] flex justify-between text-xs text-gray-600">
